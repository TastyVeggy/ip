...
public class CommandInfos {
        ...
        public static final CommandInfo MARK = new CommandInfo("mark", "mark task",
                        "mark <task index (positive Arabic numerical)");
        ...
        public static final CommandInfo TODO = new CommandInfo("todo", "add todo task",
                        "todo " + TaskType.TODO.getArgsFormat());
